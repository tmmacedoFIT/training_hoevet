...
You can add a path to a script or dataset in this file and it will never be uploaded to github. 

**Use cases:**

1. You have a script or dataset with sensitive data

2. You have a really large dataset that you don't want to use the processing to upload with every commit

3. You don't want to upload that large dataset at all, and just pull it in remotely but also keep on your local computer
